...
$rID = $_SESSION['rID'];
$sql = "UPDATE Reservation SET Reservation.dropoff_clerk_email = '$email' WHERE Reservation.reservationID = '$rID'; ";
...
<div class="mainbody">
    ...
    <div class="mainbodyWrapper2">
        ...
        <li><a class = "content">Dropoff Clerk: <?=$_SESSION['first_name']." ".$_SESSION['last_name']?></a></li><br>
        ...
        while($row = mysqli_fetch_assoc($result)) {   //Creates a loop to loop through results
            ...
            echo "<td>\${$tDeposite}</td><td>\${$tRental}</td></tr>";
        }
