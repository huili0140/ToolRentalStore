...
<div class="mainbody">
    ...
    <div class="mainbodyWrapper2">
        ...
        $sql = "SELECT Reservation.reservationID as rID, Reservation.customer_email as email, Customer.customerID as cID, " .
                ...
                "WHERE Reservation.customer_email = Customer.email AND Reservation.pickup_clerk_email IS NULL;";
        ...
        while($row = mysqli_fetch_assoc($result)) {   //Creates a loop to loop through results
            ...
            echo "<tr><td><a style=\"font-size: 12px; color: blue\" href='pickup_reservation_id.php?rID=$rID'>{$row['rID']}</a></td>";
...
<div class="mainbody">
        <div class="mainbodyWrapper2">
        <form action="pickup_reservation_id.php" method="POST">

            <input type="number" name="rID" placeholder="Enter Reservation ID">
            <button style="width: 120px;" type="submit", name="submit">Pick Up</button>
